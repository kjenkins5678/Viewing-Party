...
module.exports = app => {
  ...
  router.get("/api/club", club.findAll); 

  // ********************************************
  // club members
  // ********************************************

  router.get("/api/club_member", club_member.findAll);

  // ********************************************
  // club member maps
  // ********************************************

  router.get("/api/club_member_map", club_member_map.findAll);

  // ********************************************
  // clubs member movies  
  // ********************************************

  router.get("/api/club_member_movie", club_member_movie.findAll);

  // ********************************************
  // club member movie comments
  // ********************************************

  router.get("/api/club_member_movie_comment", club_member_movie_comment.findAll);

  // ********************************************
  // club comments 
  // ********************************************

  router.get("/api/club_comment", club_comment.findAll);
